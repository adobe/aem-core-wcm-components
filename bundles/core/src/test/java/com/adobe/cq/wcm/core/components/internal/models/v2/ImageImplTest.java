...
public class ImageImplTest extends com.adobe.cq.wcm.core.components.internal.models.v1.ImageImplTest {
    ...
    public void testSimpleDecorativeImage() {
        ...
        assertEquals(CONTEXT_PATH + escapedResourcePath + "." + selector + ".png/1494867377756" + FORWARD_SLASH+ASSET_NAME+".png", image.getSrc());
        compareJSON(
    ...
    public void testImageWithTwoOrMoreSmartSizes() {
        ...
        String expectedJson = "{\"smartImages\":[\"/core/content/test/_jcr_content/root/image0." + selector + "." + JPEG_QUALITY +
                ".600.png/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\",\"/core/content/test/_jcr_content/root/image0." + selector + "." + JPEG_QUALITY +
                ".700.png/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\",\"/core/content/test/_jcr_content/root/image0" + "." + selector + "." + JPEG_QUALITY +
                ".800.png/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\",\"/core/content/test/_jcr_content/root/image0." + selector + "." + JPEG_QUALITY +
                ".2000.png/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\", \"/core/content/test/_jcr_content/root/image0." + selector + "." + JPEG_QUALITY +
                ".2500.png/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\"],\"smartSizes\":[600,700,800,2000,2500],\"lazyEnabled\":false}";
    ...
    public void testImageFromTemplateStructure() {
        ...
        String expectedJson = "{" +
                ...
                JPEG_QUALITY +".700.png/structure/jcr%3acontent/root/image_template/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\", \"/core/content/test." +
                selector + "." + JPEG_QUALITY + ".800.png/structure/jcr%3acontent/root/image_template/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\"," +
                "\"/core/content/test." + selector + "." + JPEG_QUALITY + "." +
                "2000.png/structure/jcr%3acontent/root/image_template/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\"," + "\"/core/content/test."
                 + selector + "." + JPEG_QUALITY +".2500.png/structure/jcr%3acontent/root/image_template/1490005239000"+FORWARD_SLASH+ASSET_NAME+".png\"" + "]," +
