...
public class AdvanceSearchResultServletTest {

    private static final String TEST_BASE = "/search";

    private AdvanceSearchResultServlet underTest;
    ...
    public void testSimpleSearch() throws Exception {
        ...
        request.setQueryString(AdvanceSearchResultServlet.PARAM_FULLTEXT + "=yod");
        ...
        List<Map<String, String>> expected = ImmutableList.of(
                ...
                .put("formattedLastModifiedDate","August 03, 2017") 
    ...
    private void validateResponse(MockSlingHttpServletResponse response, List<Map<String, String>> expected) throws IOException, JSONException {
        ...
        JSONObject jsonResponse = new JSONObject(response.getOutputAsString());
        ListItem[] listItems = mapper.readValue(jsonResponse.getString("data"), ListItem[].class);
