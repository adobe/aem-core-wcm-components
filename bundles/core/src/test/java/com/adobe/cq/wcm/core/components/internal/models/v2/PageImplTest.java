...
public class PageImplTest extends com.adobe.cq.wcm.core.components.internal.models.v1.PageImplTest {
    ...
    protected static final String PN_CLIENT_LIBS = "clientlibs";
    ...
    @Test
    protected void testGetFaviconClientLibPath() throws Exception {
    ...
    @Test
    protected void testGetCssClasses() throws Exception {
