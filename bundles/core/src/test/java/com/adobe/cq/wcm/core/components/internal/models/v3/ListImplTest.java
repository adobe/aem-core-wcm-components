...
public class ListImplTest {
    ...
    protected static final String TEST_BASE = "/list/v3";
    private static final String CURRENT_PAGE = "/content/list";
    private static final String CONTEXT_PATH = "/context";
    private static final String LIST_1 = "/content/list/listTypes/staticList-1";
    private static final String LIST_2 = "/content/list/listTypes/staticList-2";
    ...
    @Test
    public void testTrackingCodeInStaticListInAuthor() throws Exception {
      CONTEXT.runMode("author");
        ...
        for ( ListItem item : list.getListItems()) {
          assertEquals("s_objectID=' " + index + "';", ((PageListItemImpl)item).getLinkTrackingCode());
          index++;
        }
    ...
    @Test
    public void testTrackingCodeInStaticList() throws Exception {
    ...
    private List getListUnderTest(String resourcePath) {
        ...
        when(component.getCellName()).thenReturn("list");
        bindings.put(WCMBindings.COMPONENT, component);
