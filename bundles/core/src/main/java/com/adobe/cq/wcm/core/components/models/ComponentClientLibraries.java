...
public interface ComponentClientLibraries {
    ...
    /**
     * Returns a set of client library categories inside the given components
     * (specified by the resource types) that match the given filter regex.
     *
     * @return Set of client library categories
     * @since com.adobe.cq.wcm.core.components.models 12.14.0
     */
