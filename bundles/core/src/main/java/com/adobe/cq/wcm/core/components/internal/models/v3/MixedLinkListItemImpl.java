...
class MixedLinkListItemImpl extends AbstractListItemImpl {
    private final Link link;
    private String linkText;

    MixedLinkListItemImpl(LinkManager linkManager, Resource resource, String parentId, Component component) {
