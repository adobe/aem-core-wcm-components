...
public class BreadcrumbItemImpl extends NavigationItemImpl implements NavigationItem {
    ...
    public BreadcrumbItemImpl(Page page, boolean active, SlingHttpServletRequest request, int level,
                              List<NavigationItem> children, boolean isShadowingDisabled) {
        super(page, active, request, level, children, isShadowingDisabled);
    }
