...
public abstract class AbstractDataSourceServlet extends SlingSafeMethodsServlet {
     ...
     */
    @Nullable
    protected String getParameter(@Nonnull Config config, @Nonnull String name,
     ...
     */
    @Nonnull
    protected Resource createResource(@Nonnull ResourceResolver resolver, @Nonnull String textValue, @Nonnull String valueValue) {
