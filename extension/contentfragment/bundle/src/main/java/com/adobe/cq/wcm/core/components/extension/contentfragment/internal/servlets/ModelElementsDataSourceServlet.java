...
public class ModelElementsDataSourceServlet extends AbstractDataSourceServlet {
    ...
    public static final String RESOURCE_TYPE = "core/wcm/extension/components/contentfragmentlist/v2/datasource/elements";

    protected static final String PARAMETER_AND_PN_MODEL_PATH = ContentFragmentListComponentModel.PN_MODEL_PATH;
    ...
    protected void doGet(@Nonnull SlingHttpServletRequest request, @Nonnull SlingHttpServletResponse response) {
        ...
        if (modelPathRequestParameter != null) {
            ...
            modelPath = componentValueMap != null ?
                componentValueMap.get(ContentFragmentListComponentModel.PN_MODEL_PATH, String.class) : null;
        }
