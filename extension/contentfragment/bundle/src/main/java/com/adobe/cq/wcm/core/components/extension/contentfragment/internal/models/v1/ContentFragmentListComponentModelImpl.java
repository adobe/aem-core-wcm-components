...
import com.adobe.cq.wcm.core.components.extension.contentfragment.internal.models.v2.ContentFragmentImpl;
...
@Model(
    ...
    adapters = {
        ContentFragmentListComponentModel.class,
        ComponentExporter.class
    },
    resourceType = ContentFragmentListComponentModelImpl.RESOURCE_TYPE
)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class ContentFragmentListComponentModelImpl implements ContentFragmentListComponentModel {

    private static final Logger LOG = LoggerFactory.getLogger(ContentFragmentListComponentModelImpl.class);

    public static final String RESOURCE_TYPE = "core/wcm/extension/components/contentfragmentlist/v1/contentfragmentlist";
    ...
    @ValueMapValue(name = ContentFragmentListComponentModel.PN_MODEL_PATH, injectionStrategy = InjectionStrategy.OPTIONAL)
    private String modelPath;

    @ValueMapValue(name = ContentFragmentListComponentModel.PN_ELEMENT_NAMES, injectionStrategy = InjectionStrategy.OPTIONAL)
    private String[] elementNames;

    @ValueMapValue(name = ContentFragmentListComponentModel.PN_TAG_NAME, injectionStrategy = InjectionStrategy.OPTIONAL)
    private String[] tagNames;

    @ValueMapValue(name = ContentFragmentListComponentModel.PN_FOLDER_NAME, injectionStrategy = InjectionStrategy.OPTIONAL)
    private String parentPath;

    private List<ContentFragment> items = new ArrayList<>();
    ...
    private void initModel() {
        ...
        try {
            ...
            while (resourceIterator.hasNext()) {
                ...
                ContentFragment contentFragmentModel = new ContentFragmentImpl(
    ...
    @Nonnull
    @Override
    public Collection<ContentFragment> getListItems() {
        return items;
    }
