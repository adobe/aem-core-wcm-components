...
public class ContentFragmentImpl implements ContentFragment {
    ...
    private final String contentFragmentPath;

    private String type;
    private List<ContentElement> elements;
    private Map<String, ContentElement> exportedElements;
     ...
     */
    public ContentFragmentImpl(@Nonnull Resource contentFragmentResource,
                               @Nonnull ContentTypeConverter contentTypeConverter,
        ...
        this.contentFragmentPath = contentFragmentResource.getPath();
        ...
        if (contentFragment == null) {
            ...
            final Iterator<com.adobe.cq.dam.cfm.ContentElement> contentElementIterator =
            ...
            while (contentElementIterator.hasNext()) {
                final com.adobe.cq.dam.cfm.ContentElement contentElement = contentElementIterator.next();
                com.adobe.cq.dam.cfm.ContentVariation variation = null;
                ...
                this.exportedElements.put(contentElement.getName(),
                    new ContentElementImpl(contentTypeConverter, contentElement, variation));
            }
    ...
    public static class ContentElementImpl implements ContentElement {
        ...
        private static final Logger LOG = LoggerFactory.getLogger(ContentElementImpl.class);

        private static final String TEXT_HTML = "text/html";

        private final ContentTypeConverter converter;
        private final com.adobe.cq.dam.cfm.ContentElement element;
         ...
         */
        public ContentElementImpl(@Nonnull ContentTypeConverter converter,
                                  @Nonnull com.adobe.cq.dam.cfm.ContentElement element,
        ...
        public String[] getParagraphs() {
            ...
            String contentType = getContentType();
            if (TEXT_HTML.equals(contentType)) {
                // get the html of the fragment
                String html = getHtml();
                if (html != null) {
                    return html.split("(?=(<p>|<h1>|<h2>|<h3>|<h4>|<h5>|<h6>))");
                }
            } else {
