...
* **Vendor**: Adobe
* **Version**: v1
* **Compatibility**: AEM as a Cloud Service, AEM 6.5 LTS (including Adobe Managed Services) for search results. The visitor-facing generative-summary toggle is unsupported and hidden on AEM 6.5 (any service pack) - it is only rendered on AEM as a Cloud Service.
