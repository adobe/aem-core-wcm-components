...
Also exports a full json representation in the JSON export of the variation.
...
* Exports the complete underlying JSON content of the experience fragment. For this to work, the components in the experience fragment must have an exporter as well.
...
* **Co-authors**: [Jean-Christophe Kautzmann](https://github.com/jckautzmann) [Niek Raaijmakers](https://github.com/niekraaijmakers)
