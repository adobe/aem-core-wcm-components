...
16. `./linkTrackingEnabled` - if set to `true` link tracking will be enabled
15. `./objectId` - Default data will be present in the field for tracking . User can change it.
