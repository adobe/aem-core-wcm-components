...
(function (document, window, $) {
    ...
    $(document).on("foundation-contentloaded", function (e) {
        ...
        var documentCloudSuffix = '/settings/cloudconfigs/documentcloud/',
            $wizardForm = $('#documentcloud-cloudconfig-form'),
            $propertiesForm = $('#documentcloud-properties-form');
        ...
        var configAlreadyExists = function (configName, configContainer) {
            ...
            submitForm = function ($form, url) {
                $.ajax({
                    ...
                    window.location.href = Granite.HTTP.externalize("/mnt/overlay/core/wcm/cloudservices/documentcloud.html" + configurationContainer);
        ...
        $(window).adaptTo("foundation-registry").register("foundation.validation.validator", {
            selector : "[data-foundation-validation~='recaptcha.cloud.config'],[data-validation~='recaptcha.cloud.config']",
