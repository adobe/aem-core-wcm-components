...
import com.adobe.cq.wcm.core.components.it.seljup.components.FormText.FormTextConfigDialog;
import com.adobe.cq.wcm.core.components.it.seljup.components.FormText.FormText;
...
public class FormTextTests {
    ...
    public void setup(CQClient client, String formTextRT, String rootPage,
                      String defaultPageTemplate, FormText formText) throws ClientException {
    ...
    public void setLabel() throws InterruptedException, TimeoutException {
        openConfig();
        FormTextConfigDialog configDialog = formText.getConfigDialog();
