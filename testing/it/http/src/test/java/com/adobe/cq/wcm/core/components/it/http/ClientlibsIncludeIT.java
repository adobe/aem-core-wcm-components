...
public class ClientlibsIncludeIT {
    ...
    public void testJsInclude() throws ClientException {
        ...
        GraniteAssert.assertRegExFind("Incorrect script and/or script attributes" + pageHtml + appsOutput, content, REGEX_SCRIPT_ELEMENT);
    }
    ...
    public void testCssInclude() throws ClientException {
        ...
        GraniteAssert.assertRegExFind("Incorrect link and/or link attributes" + pageHtml + appsOutput, content, REGEX_LINK_ELEMENT);
    }
